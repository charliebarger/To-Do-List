...
/* harmony export */   "toggleClassOnEvent": () => (/* binding */ toggleClassOnEvent)
/* harmony export */ });
...
/* harmony import */ var _burgerMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./burgerMenu.js */ "./src/burgerMenu.js");
...
class NewTask{
    ...
    createWrapper() {
        ...
        ;(0,_burgerMenu_js__WEBPACK_IMPORTED_MODULE_0__.toggleClassOnEvent)(coreWrapper, 'hide-it', description)
    ...
    createCheckBox(){
        ...
        ;(0,_burgerMenu_js__WEBPACK_IMPORTED_MODULE_0__.toggleClassOnEvent)(checkbox, "checkbox-clicked")
        checkbox.addEventListener('click', () => {
            console.log((0,_storage__WEBPACK_IMPORTED_MODULE_1__.matchIndexNumbers)(checkbox.parentElement.parentElement.dataset.indexNumber))
    ...
    createDueDate(){
        ...
        if (this.dueDate){
            ...
            let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(selectedDate, 'MMMM dd, yyyy')
...
function createTask(taskName, dueDate, priority, description, number, selected){
...
/* harmony import */ var _taskSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskSection */ "./src/taskSection.js");
...
;(0,_taskSection__WEBPACK_IMPORTED_MODULE_3__.clearCompleted)()
// addTaskListner()
// updateFolders()
// };
...
/* harmony import */ var _taskSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskSection */ "./src/taskSection.js");
...
function addTasks(){
    (0,_taskSection__WEBPACK_IMPORTED_MODULE_2__.removeImage)()
    let tasks = getTaskValues()
    ;(0,_storage__WEBPACK_IMPORTED_MODULE_0__.addStorageTasks)(tasks.taskName, tasks.dueDate, tasks.priority, tasks.description)
    ;(0,_storage__WEBPACK_IMPORTED_MODULE_0__.appendLastStorageTask)()
}
...
function renderSelectedClass(item) {
    ...
    ;(0,_taskSection__WEBPACK_IMPORTED_MODULE_2__.appendTasks)()
}
...
/* harmony export */ });
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage */ "./src/storage.js");
/* harmony import */ var _taskSection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskSection */ "./src/taskSection.js");
...
function selectFirstProject() {
    ...
    (0,_taskSection__WEBPACK_IMPORTED_MODULE_1__.appendTasks)()
}
...
/* harmony export */   "appendLastStorageTask": () => (/* binding */ appendLastStorageTask),
/* harmony export */   "matchIndexNumbers": () => (/* binding */ matchIndexNumbers),
/* harmony export */   "removeSelectedFromStorage": () => (/* binding */ removeSelectedFromStorage)
/* harmony export */ });
/* harmony import */ var _createNewProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createNewProject */ "./src/createNewProject.js");
/* harmony import */ var _selectTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectTask */ "./src/selectTask.js");
     ...
     for (let i = 0; i < localFolder.length; i++){
        if (localFolder[i].title == selectedFolder){
            ...
            localFolder[i].tasks.forEach(task => {
                (0,_createNewTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(task.taskName, task.dueDate, task.priority, task.description, task.indexNumber, task.selected)
            });
        }
    }
    return true
...
function appendLastStorageTask() {
    ...
    ;(0,_createNewTask__WEBPACK_IMPORTED_MODULE_2__.createTask)(lastItem.taskName, lastItem.dueDate, lastItem.priority, lastItem.description, lastItem.indexNumber, lastItem.selected)
}
...
function getLocalStorageProject() {
    ...
    if (!loadTasks()){
        (0,_taskSection__WEBPACK_IMPORTED_MODULE_3__.appendPlaceHolder)()
    }
}
...
/* harmony export */   "appendPlaceHolder": () => (/* binding */ appendPlaceHolder),
...
function appendTasks() {
    removeTasks()
    console.log('hi')
     if (!(0,_storage__WEBPACK_IMPORTED_MODULE_0__.loadTasks)()){
         appendPlaceHolder()
     }
}
...
function clearCompleted(params) {
    ...
    clearCompletedButton.addEventListener('click', () => {
        (0,_storage__WEBPACK_IMPORTED_MODULE_0__.removeSelectedFromStorage)()
        appendTasks()
    })
}
